...
const SKILLS = ['Sin asignar', 'Representar', 'Resolver problemas', 'Modelar', 'Argumentar y comunicar'];
const UNITS  = ['Sin asignar', 'Números', 'Álgebra y funciones', 'Geometría', 'Probabilidad y estadística'];
